...
class WorkspacesController extends Controller
{
    ...
    public function destroy_multiple(Request $request)
    {
        ...
        if (!empty($isCurrentWorkspace)) {
            $message = 'Current workspace cannot be deleted.';
        } elseif (empty($deletedWorkspaces)) {
            $message = 'No workspaces were deleted.';
        } else {
            $message = 'Workspace(s) deleted successfully.';
        }

        return response()->json([
            'error' => !empty($isCurrentWorkspace), 'message' => $message,'deleted_ids' => $deletedWorkspaces,'deleted_titles' => $deletedWorkspaceTitles,'not_deleted_ids' => $isCurrentWorkspace,
        ]);
    }
