...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard', ['users' => $users, 'clients' => $clients, 'projects' => $projects, 'tasks' => $tasks, 'todos' => $todos, 'total_todos' => $total_todos, 'meetings' => $meetings, 'auth_user' => $this->user, 'statuses' => $statuses, 'activities' => $activities , 'customFields' => $customFields ]);
    }
    ...
    public function upcoming_birthdays()
    {
        ...
        $currentDateString = $currentDate->format(format: 'Y-m-d');
