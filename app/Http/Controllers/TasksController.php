...
class TasksController extends Controller
{
    ...
    public function index($id = '')
    {
        ...
        // dd($customFields);
        return view('tasks.tasks', ['project' => $project, 'tasks' => $tasks, 'users' => $users, 'clients' => $clients, 'projects' => $projects, 'toSelectTaskUsers' => $toSelectTaskUsers, 'customFields' => $customFields]);
    }
    /**
    ...
    public function show($id)
    {
        ...
        return view('tasks.task_information', ['task' => $task, 'auth_user' => $this->user, 'customFields' => $customFields]);
    }
    /**
    ...
    public function dragula($id = '')
    {
        ...
        return view('tasks.board_view', ['project' => $project, 'tasks' => $tasks, 'total_tasks' => $total_tasks, 'projects' => $projects, 'toSelectTaskUsers' => $toSelectTaskUsers, 'customFields' => $customFields]);
    }
    ...
    public function calendar_view()
    {
        ...
        return view('tasks.calendar_view', compact('projects', 'project_id', 'customFields'));
    }
    ...
    public function group_by_task_list(Request $request)
    {
        ...
        try {
            ...
            return view('tasks.group_by_task_lists', compact('taskLists', 'projects', 'tasks', 'toSelectTaskUsers', 'customFields'));
        } catch (\Exception $e) {
            // dd($e);
