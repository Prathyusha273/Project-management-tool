...
class ProjectsController extends Controller
{
    ...
    {
        $project = Project::with('customFieldValues')->findOrFail($id);
        // dd($project);
        $users = $this->workspace->users;
        $clients = $this->workspace->clients;
        $adminId = getAdminIdByUserRole();
        ...
        // Get custom fields for the Project module
        $customFields = CustomField::where('module', 'project')->get();
    ...
    {
        $project = Project::with('customFieldValues.customField')->findOrFail($projectId);
    ...
    public function calendar_view()
    {
        ...
        $customFields = CustomField::where('module', 'project')->get();
        $is_favorites = 0;
        return view('projects.calendar_view', compact('projects', 'is_favorites', 'customFields'));
    }
