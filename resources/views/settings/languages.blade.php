...
{!! create_label('task_status_updation', 'Task Status Updation', Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('projects_and_tasks_management', 'Projects And Tasks Management', Session::get('locale')) !!}
                            {!! create_label('team', 'Team', Session::get('locale')) !!}
                            ...
                            {!! create_label('time_sheet_report', 'Time Sheet Report', Session::get('locale')) !!}
                            {!! create_label('holiday_calendar', 'Holiday calendar', Session::get('locale')) !!}
                            {!! create_label('calendars', 'Calendars', Session::get('locale')) !!}
                            {!! create_label('event_type', 'Event Type', Session::get('locale')) !!}
                        ...
                        <div>
                            ...
                            {!! create_label('text', 'Text', Session::get('locale')) !!}
                            {!! create_label('number', 'Number', Session::get('locale')) !!}
                            {!! create_label('textarea', 'Textarea', Session::get('locale')) !!}
                            {!! create_label('radio', 'Radio', Session::get('locale')) !!}
                            {!! create_label('date', 'Date', Session::get('locale')) !!}
                            {!! create_label('checkbox', 'Check Box', Session::get('locale')) !!}
                            {!! create_label('date', 'Date', Session::get('locale')) !!}
                            {!! create_label('confirm_deletion', 'Confirm Deletion', Session::get('locale')) !!}
                            {!! create_label('confirm_message', 'Are you sure you want to delete this field?', Session::get('locale')) !!}
                            {!! create_label('no_custom_fields', 'No custom fields for this project', Session::get('locale')) !!}
                            {!! create_label('custom_fields', 'Custom fields', Session::get('locale')) !!}
                            {!! create_label('is_required', 'Is Required', Session::get('locale')) !!}
                            {!! create_label('optional', 'Optional', Session::get('locale')) !!}
                            {!! create_label('add_field' ,'Add Fields', Session::get('locale'))!!}
                        </div>

                        <div>
                            {!! create_label('documentation_for_integration_with_google_calendar' ,'Documentation for integration with Google Calendar', Session::get('locale'))!!}
                            ...
                            {!! create_label('please_enter_your_google_calendar_id' ,'Please Enter Your Google Calendar ID', Session::get('locale'))!!}
                            {!! create_label('custom_holiday_name' ,'Custom Holiday Name', Session::get('locale'))!!}
                            {!! create_label('please_enter_custom_holiday_name' ,'Please Enter Custom Holiday Name', Session::get('locale'))!!}
                            {!! create_label('google_calendar_integration' ,'Google Calendar Integration', Session::get('locale'))!!}
                            {!! create_label('google_calendar_not_configured' ,'Google Calendar is Not Configured Properly.', Session::get('locale'))!!}
                            {!! create_label('click_here_to_configure' ,'Click Here to Configure', Session::get('locale'))!!}
