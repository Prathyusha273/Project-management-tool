    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <label class="form-label">{{ get_label('custom_fields', 'Custom Fields') }}</label>
                    </div>
                    {{-- @dd($customFields); --}}
                    <div class="card-body">
                        @php
...
@if($hasValues)
    <div class="row">
        @foreach($customFields as $field)
            ...
            @if($fieldValue)
                <div class="col-md-6 mb-3">
                    <label class="form-label small mb-1 d-block text-truncate w-100" title="{{ $field->field_label }}">{{ $field->field_label }}</label>
                    ...
                    @switch($field->field_type)
                                ...
                                <div>
                                    @foreach($options as $option)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="{{ $option }}" {{ $currentValue == $option ? 'checked' : '' }} disabled>
                        ...
                        @case('date')
                            <input type="text" class="form-control" value="{{ $fieldValue ? $fieldValue : '' }}" readonly>
                            @break
                        ...
                        @case('checkbox')
                            ...
                            <div>
                                @foreach($options as $option)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{ $option }}" {{ in_array($option, $currentValues) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label">
                                            {{ $option }}
                                        </label>
                                    </div>
                        ...
                        @case('color')
                            <div class="d-flex align-items-center">
                                <div class="me-2" style="width: 25px; height: 25px; background-color: {{ $fieldValue ?? '#FFFFFF' }}; border: 1px solid #ddd; border-radius: 4px;"></div>
